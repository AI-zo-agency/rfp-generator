...
import { filterClientMapRows, mappingHandoffError, paginateClientMapRows } from "./ClientMapPanels";
...
describe("mapping review queue", () => {
  const rows: ClientMapRow[] = [
    mappedClient,
    { ...mappedClient, id: "client-2", tag_code: "NORTH", client_name: "North Star", link_confidence: "suggested" },
    { ...mappedClient, id: "client-3", tag_code: "ORBIT", client_name: "Orbit", link_confidence: "unmatched" },
  ];
