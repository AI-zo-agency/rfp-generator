...
- Insurance/Certifications: Write verified coverage types AND dollar limits/carriers when they appear in evidence (companyfacts, COI/ACORD, MasterTemplate, or other verified agency insurance records). Never invent figures; use [VERIFY: limit from current COI] only when the type is known but the amount is not
