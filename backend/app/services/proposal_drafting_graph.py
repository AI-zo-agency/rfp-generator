...
33. ANTI-DUPLICATION: Each section has ONE job. Do not re-write Who We Are, full bios, full case studies, FEIN/address/certs, or brand story that belongs in Sections 1–3 or another RFP tab. Do not paraphrase another RFP tab (Approach≠Methodology rewrite; Past Performance≠Sample Work dump). One brief cross-reference is OK — then add NEW RFP-specific detail only. Prefer concise, concrete prose within wordTarget — no generic agency marketing filler. Offeror / Vendor / Company Identification forms: ONE short FIELD|RESPONSE table synced from Section 1.3 Business Information + a one-line cross-reference — NEVER a second full company profile / Who We Are dump.
...
45. SCHEDULE / TIMELINE: Fit award→launch / contract windows stated in the RFP. Dates and milestones in a table — methodology lives in Approach. Every Timing cell must have a week-from-award range. Never leave Timing blank. Never put writer instructions in the tab ("do not restate…"). Missing calendar dates from the RFP → weeks from award, not [VERIFY] tags.
